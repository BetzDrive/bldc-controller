...
/**
 * Texas Instruments DRV8301 Three-Phase Gate Driver With Dual Current Shunt Amplifiers and Buck Regulator
 */
class DRV8301 {
public:
  DRV8301(SPIDriver& spi_driver, PWMDriver& pwm_driver,
