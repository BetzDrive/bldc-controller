...
namespace motor_driver {
  namespace peripherals {
    ...
    adcsample_t ivsense_sample_buf[
      consts::ivsense_channel_count * consts::ivsense_sample_buf_depth];

    static void ivsenseADCEndCallback(
    ...
    void startPeripherals() {
      ...
      adcStartConversion(
          &ADCD1, &ivsense_adc_group, ivsense_sample_buf,
          consts::ivsense_sample_buf_depth);
      adcStartConversion(
          &ADCD2, &currb_adc_group,
          ivsense_sample_buf + (2 * consts::ivsense_sample_buf_depth),
          consts::ivsense_sample_buf_depth);
      adcStartConversion(
          &ADCD3, &currc_adc_group,
          ivsense_sample_buf + (3 * consts::ivsense_sample_buf_depth),
          consts::ivsense_sample_buf_depth);
