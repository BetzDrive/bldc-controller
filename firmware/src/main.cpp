...
namespace motor_driver {
  ...
  int main(void) {
    ...
    chThdCreateStatic(
        watchdog_thread_wa, sizeof(watchdog_thread_wa), HIGHPRIO,
    ...
    // Start threads
    chThdCreateStatic(
        blinker_thread_wa, sizeof(blinker_thread_wa), LOWPRIO,
        blinkerThreadRun, NULL);
    chThdCreateStatic(
        sensor_thread_wa, sizeof(sensor_thread_wa), LOWPRIO, sensorThreadRun,
        NULL);
    chThdCreateStatic(
        comms_thread_wa, sizeof(comms_thread_wa), NORMALPRIO, commsThreadRun,
        NULL);
    chThdCreateStatic(
        control_thread_wa, sizeof(control_thread_wa), HIGHPRIO,
