...
void pwmSetChannelOutputMode(PWMDriver *pwm_driver, pwmchannel_t channel,
  ...
  switch (channel) {
    case 0:
      pwm_driver->tim->CCMR1 = (
          (pwm_driver->tim->CCMR1 & ~TIM_CCMR1_OC1M) |
          STM32_TIM_CCMR1_OC1M(output_mode));
      break;
    case 1:
      pwm_driver->tim->CCMR1 = (
          (pwm_driver->tim->CCMR1 & ~TIM_CCMR1_OC2M) |
          STM32_TIM_CCMR1_OC2M(output_mode));
      break;
    case 2:
      pwm_driver->tim->CCMR2 = (
          (pwm_driver->tim->CCMR2 & ~TIM_CCMR2_OC3M) |
          STM32_TIM_CCMR2_OC3M(output_mode));
      break;
    case 3:
      pwm_driver->tim->CCMR2 = (
          (pwm_driver->tim->CCMR2 & ~TIM_CCMR2_OC4M) |
