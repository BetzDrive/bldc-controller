...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Download json calibrations off a set of boards!')
    parser.add_argument('serial', type=str, help='Serial port')
    parser.add_argument('--baud_rate', type=int, help='Serial baud rate')
    parser.add_argument('board_ids', type=str, help='Board ids to read from')
    parser.add_argument('--calibration_file', type=str, help='The file which the calibrations will be put in')
    parser.set_defaults(baud_rate=COMM_DEFAULT_BAUD_RATE, calibration_file='downloaded_calibrations.json')
