...
phase_state_list = [(0, 0, i) for i in np.arange(0.9, 1, 0.01)]
...
if __name__ == '__main__':
    ...
    parser.set_defaults(baud_rate=COMM_DEFAULT_BAUD_RATE, steps=len(phase_state_list), delay=0.015, file_name='')
